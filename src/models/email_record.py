...
class EmailRecord:
    ...
    clarification_history: Optional[list[Dict[str, str]]] = None  # [{question, answer, timestamp}]
    original_body: Optional[str] = None  # Preserve original before merging clarifications
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'EmailRecord':
        ...
        return cls(
            ...
            last_clarification_question=data.get('last_clarification_question'),
        )
